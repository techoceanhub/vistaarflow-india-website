...
<main id="main" class="legal-page">
  ...
  <div class="container narrow legal-content">
    ...
    <?php if (!$is_refund): ?><section class="legal-card legal-contact"><h2><?php echo esc_html($is_privacy ? '9. Contact And Grievance Redressal' : '13. Contact'); ?></h2><p><?php if ($is_privacy): ?>For privacy questions, data requests, or grievance redressal, contact Techoceanhub Private Limited at <a href="mailto:support@techoceanhub.com">support@techoceanhub.com</a>. Please include your account email, business name, and request details so we can verify and respond appropriately.<?php else: ?>For questions about these Terms, contact Techoceanhub Private Limited at <a href="mailto:support@techoceanhub.com">support@techoceanhub.com</a>.<?php endif; ?></p></section>
